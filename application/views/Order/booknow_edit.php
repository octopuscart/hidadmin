...
<div id="content" class="content">
    <section class="" style="min-height: auto;" >
        ...
        <script>
            ...
            $(function () {
                $("#select_date").val("<?php echo $bookdetails->select_date; ?>");
                $("#idselecttime").val("<?php echo $bookdetails->select_time; ?>");
                $("#idselectperson").val("<?php echo $bookdetails->people; ?>");
                $("#idsource").val("<?php echo $bookdetails->order_source; ?>");
            })

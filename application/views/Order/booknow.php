                                    ...
                                    <div class=" mt-4 mt-lg-0" >
                                        ...
                                        <form class="mb-0 row"  action="#" method="post" >
                                            ...
                                            <div class="col-sm-6 mb-3 input-daterange travel-date-group">
                                                <input type="date" id="template-contactform-subject" name="select_date" value="" class="form-control border-form-control  required" placeholder="Select Reservation Date" min="<?php echo date('Y-m-d', strtotime('-30 days'));?>" required="">
                                            </div>
                                            <div class="clear"></div>
